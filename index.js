...
//
const BotName = 'BOT ./BloodSword'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/demo_ngki'; // Nama Instagramlu cok
const whatsapplu = '085784830497'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/EQtnLZu5lzD87Lq1w37x0O'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/EFxmRoWiYB1GOlogNBJAAh'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
const corohelp = await get.get('085884830497').json()
var date = new Date();
var tahun = date.getFullYear();
var bulan = date.getMonth();
var tanggal = date.getDate();
...
const corohelp = await get.get('085784830497').json()
var date = new Date();
var tahun = date.getFullYear();
var bulan = date.getMonth();
var tanggal = date.getDate();
